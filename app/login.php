      ...
      if (!empty($password)) {
        ...
        if ($query) {
          if (mysqli_num_rows($query) > 0 ) {
            ...
            $notify = "<span class=\"text-danger\">Email or password is incorrect!</span>";
          }
        }else {
...
<head>
  ...
  <body class="" style="background-image: url('images/bg.jpg'); background-repeat: no-repeat;">
    ...
    <div class="container">
        ...
        <div class="col-md-12">
              <h2 style="color:#fff; font-size:40px; text-align:center;">Login</h2>
        </div>
      ...
      <form style="margin-top:0%;" class="login-form" action="login.php" method="post">        
        <div class="login-wrap">
            ...
            <div class="input-group">
              ...
              <input type="email" class="form-control" placeholder="Username" value="<?php echo $username;  ?>" id="username" name="username" autofocus required>
            </div>
            <div class="input-group">
