      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row col-lg-12">
              ...
              <a href="VJSS3.php"><button id="viewbtn" class="btn btn-warning pull-center">View Uploaded Videos</button></a>
          </div><br><!-- /.row -->          
          ...
          <div class="box" style="font-size:12px;">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped" style="over-flow:scroll;">
                ...
                <tbody>
                  <?php
                    $query = mysqli_query($connect,"SELECT * FROM videos WHERE class ='JSS3' ORDER BY DateCreated DESC");
                    ...
                    if (mysqli_num_rows ($query)> 0) {
                      ...
                      while ($rows = mysqli_fetch_array($query) ){
                        ...
                        <a href="VJSS3.php?ID='. $ID . ' && passport='.$passport.'">
