      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row col-lg-12">
              ...
              <a href="VSSS3.php"><button id="viewbtn" class="btn btn-warning pull-center">View Uploaded Videos</button></a>
          </div><br><!-- /.row -->          
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <select required type="text" class="form-control" id="module" name="module">
                              ...
                              <option value="Factorising Cubic Polynomials">Factorising Cubic Polynomials</option>
                              ...
                              <option value="Combinations and Permutations">Combinations and Permutations</option>
                            </select>
                          </div>
                          <div class="form-group">
          ...
          <div class="box" style="font-size:12px;">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped" style="over-flow:scroll;">
                ...
                <tbody>
                  <?php
                    $query = mysqli_query($connect,"SELECT * FROM videos WHERE class ='SSS3' ORDER BY DateCreated DESC");
                    ...
                    if (mysqli_num_rows ($query)> 0) {
                      ...
                      while ($rows = mysqli_fetch_array($query) ){
                        ...
                        <a href="VSSS3.php?ID='. $ID . ' && passport='.$passport.'">
