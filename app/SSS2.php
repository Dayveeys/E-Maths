...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($passportfilesize <= 0){
      $error = "Please Upload a Courseware of Not More Than 50mb!";
    }
    else if ($passportfilesize >= 50242880){
      $error = "File Cannot Be More Than 50mb!";
    }
      ...
      $sql = "INSERT INTO courseware (topic, title, module, class, description, media)
      VALUES ('$phone', '$name', '$module', 'SSS2', '$email', '$passportfilename')";
 ...
 $passport='';
  ...
  $delSQl = "DELETE FROM courseware WHERE ID = '$ID'";
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row col-lg-12">
              <button class="btn btn-success left-block" id="shobtn">Upload New Courseware</button>
              <a href="SSS2.php"><button id="viewbtn" class="btn btn-warning pull-center">View Uploaded Coursewares</button></a>
          </div><br><!-- /.row -->          
                  
                  <div style="margin-top: 3%;" id="usereg" class="center-block panel panel-primary" style="width:60%;">
                    <div class="panel-heading">
                      <h3 class="title align-center">Courseware Upload Panel<button style="float: right; margin-top: -0.5%;" class="btn btn-default right-block" id="dhbtn">Close</button></h3>
                    </div>
                    <div class="panel-body">
                      <!-- Tooltip -->
                        <div id="tooltipm" class="tooltipm">
                          <h3>
                            Courseware Successfully Uploaded!<br>
                          </h3>
                        </div><br><br>
                      <!-- //Tooltip -->  
                      <form role="form" action="<?php htmlspecialchars ($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                          <label>
                          Click here to insert Courseware to be Uploaded <i style="font-size: 10px;">(Only PDF files are allowed)</i></label>
                          ...
                          <div class="form-group">
                            ...
                            <select required type="text" class="form-control" id="module" name="module">
                              ...
                              <option value="Relations, Functions and Graphs">Relations, Functions and Graphs</option>
                              <option value="Trigonometry">Trigonometry</option>
                              <option value="Geometry">Geometry</option>
                              <option value="Sets">Sets</option>
                              <option value="Functions">Inverse Functions</option>
                              <option value="Vectors and Matrices">Vectors and Matrices</option>
                              <option value="Transformation Geometry">Transformation Geometry</option>
                              <option value="JSS3">Measurement 2</option>
                              <option value="Patterns and Sequencies">Patterns and Sequencies</option>
                            </select>
                          </div>
                          <div class="form-group">
                            <label for="topic">Sub-Topic <i style="font-size: 10px;">(This is optional, only to be entered if needed)</i></label>
                            <input type="text" class="form-control" id="topic" name="topic" placeholder="Enter Courseware Sub-Topic under the selected Module">
                          </div>
                          <div class="form-group">
                            <label for="name">Title</label>
                            <input required type="text" class="form-control" name="name" id="name" placeholder="Enter Courseware Title">
                          </div>
                          <div class="form-group">
                            <label for="email">Brief Description</label>
                            <textarea id="description" class="form-control textarea" style="height: 100px;" type="text" name="description" placeholder="Enter a brief Description of the Courseware"></textarea>
                          </div>
                          <!--<div class="checkbox">
                            <label>
          ...
          <div class="box" style="font-size:12px;">
            <div class="box-header">
              <h3 class="box-title">Uploaded Courseware</h3>
              <?php
              if (isset($msg) && $msg !=='') {
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped" style="over-flow:scroll;">
                ...
                <tbody>
                  <?php
                    $query = mysqli_query($connect,"SELECT * FROM courseware WHERE class ='SSS2' ORDER BY DateCreated DESC");
                    ...
                    if (mysqli_num_rows ($query)> 0) {
                      ...
                      while ($rows = mysqli_fetch_array($query) ){
                        ...
                        <a href="SSS2.php?ID='. $ID . ' && passport='.$passport.'">
