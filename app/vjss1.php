      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row col-lg-12">
              ...
              <a href="vjss1.php"><button id="viewbtn" class="btn btn-warning pull-center">View Uploaded Videos</button></a>
          </div><br><!-- /.row -->          
                  ...
                  <?php
                    ...
                    if (mysqli_num_rows ($query)> 0) {
                      ...
                      while ($rows = mysqli_fetch_array($query) ){
                        ...
                        <a href="vjss1.php?ID='. $ID . ' && passport='.$passport.'">
